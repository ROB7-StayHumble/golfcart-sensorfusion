...
kp1, des1 = brisk.detectAndCompute(ir,None)
kp2, des2 = brisk.detectAndCompute(zed,None)
# create BFMatcher object
bf = cv2.BFMatcher(cv2.NORM_HAMMING, crossCheck=True)
# Match descriptors.
matches = bf.match(des1,des2)
...
img3 = cv2.drawMatches(ir,kp1,zed,kp2,matches[:20], None, flags=2)
plt.imshow(img3)
plt.savefig("feature_matching/feature_matching_brisk.png", bbox_inches='tight', pad_inches=0)
plt.show()